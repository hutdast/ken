...
class ChoicesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //print("iniside the lisofaddresses..:\(listOfAddresses.count)")
    ...
    override func viewWillAppear(animated: Bool) {
        listOfAddresses = tempDB.displayAllFromDatabase().name
        print("iniside the lisofaddresses..:\(listOfAddresses.count)")
    }
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return self.listOfAddresses.count
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let getOptions = listOfAddresses[indexPath.row]
